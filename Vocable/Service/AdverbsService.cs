...
namespace Vocable.Service
{
    public class AdverbsService
    {
        ...
        public void AddAnAdverbQuestionRepo()
        {
            ...
            _adverbQuestionsRepo.Create(new Adverb_Question { Id = 1, Question = "hablar", HelpImagePath = "/images/comer_image.gif", HelpEnglish = "to speak", HelpSentence = "Yo hablo español." });
