...
namespace Vocable.Service
{
    public class AdverbsService
    {
        ...
        public void AddAnAdverbQuestionRepo()
        {
            ...
            // Creating questions
            _adverbQuestionsRepo.Create(new Adverb_Question { Id = 1, Question = "hablar", HelpImagePath = "/images/hablar_image.gif", HelpEnglish = "to speak", HelpSentence = "Yo hablo español." });
            ...
            _adverbQuestionsRepo.Create(new Adverb_Question { Id = 12, Question = "leer", HelpImagePath = "/images/leer_image.gif", HelpEnglish = "to read", HelpSentence = "Ella lee un libro." });
        }
